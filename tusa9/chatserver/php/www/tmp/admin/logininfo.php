<?
	...
	$uid=$_SESSION['uid'];
     ...
     if(!isset($login) || $_SESSION['level']<900)
     {
     	header("Location: /");
     }
     else
...
<tr><td align=right>Уровень_изменен: </td><td><font class=infd><? 
	if($zpoweshen==0) echo "VOTE"; else echo mysql_select1("select login from tbl_users where id='$zpoweshen'")
?></td></tr>
