...
void read_messages()
{
    privmsgs[0]=dbh->select_1_column("select answer from privmsg where gender=0");
    privmsgs[1]=dbh->select_1_column("select answer from privmsg where gender=1");
    privmsgs[2]=dbh->select_1_column("select answer from privmsg where gender=2");
    msgs[0]=dbh->select_1_column("select answer from msg where gender=0");
    msgs[1]=dbh->select_1_column("select answer from msg where gender=1");
    msgs[2]=dbh->select_1_column("select answer from msg where gender=2");
    greetingmsgs[0]=dbh->select_1_column("select answer from greetingmsg where gender=0");
    greetingmsgs[1]=dbh->select_1_column("select answer from greetingmsg where gender=1");
    greetingmsgs[2]=dbh->select_1_column("select answer from greetingmsg where gender=2");
}
