...
<center>
<input type="radio" name="res" value="1"> Победил <?=$row[0] ?>
<input type="radio" name="res" value="2"checked="1"> Ничья в основное время
<input type="radio" name="res" value="3"> Победил <?=$row[1] ?> <br> <br>
<input type=textfield style='width: 65px' size='8' maxlength='8' name="score"> <br><br>
<input type="hidden" name="match" value="<?=$arg_id?>">
<input type=submit name="save_res" value="Записать результат" >
</center>
</center>
</form>
