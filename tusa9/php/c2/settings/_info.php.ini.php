<?
		...
		list($bd,$bm,$by,$city,$name,$hide_name,$hide_bdate,$info)=mysql_select1row("select day(birth_date),month(birth_date),year(birth_date),city,name,hide_name,hide_bdate,info from tbl_users where id='$uid'");
