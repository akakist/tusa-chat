...
<table cellpadding=0 cellspacing=0 border=0 width=100%>
	...
	<input type=checkbox id=save name=save><label for=save> запомнить</label><br><br>
	<input type=submit value="Вход" name=subm class=enter>
	</form>
	</td></tr>
	</table>
	...
	<td width=650 valign=top align=left id=index_info>
	    <p class=index_text>
	    Вы хотели приятного и непринужденного общения? Может быть Вы хотели бы найти себе новых друзей?<br>
	    Да, да, здесь это и много другое возможно :-)<br><br>
	    Итак, после регистрации Вы сможете:
	    </p>
	    <ul class=index_text>
        	<li>Найти новых друзей;
		<li>Узнать о своих друзьях много нового;
		<li>Постоянно оставаться на связи с Вашими близкими;
		<li>И в конце концов, просто приятно провести время.
	    </ul>
	    <p class=index_text2>
	    Заинтересовались? Приступить к <a href=# onclick="show_reg(); return false;">регистрации</a>.
	    </p>
	</td>
