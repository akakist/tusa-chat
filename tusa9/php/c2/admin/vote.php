...
<?
    ...
    if(isset($arg_add_ball)&&isset($arg_add_login))
        {
        $zid=mysql_select1("select id from tbl_users where login='".mysql_escape_string($arg_add_login)."'");
        if ($zid<1)
    	    {
...
?>
	...
	<br><b> Сумма баллов <?=$perc?> </b><br>
        ...
        <input type=submit value="OK" style="width: 2em" >
        </form>
        
        <!-- 
        onclick="location.href=/c2/admin/vote.php"
        -->
