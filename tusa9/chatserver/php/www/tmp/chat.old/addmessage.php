<?
  ...
  if ($uid)
  {
      list($level,$last_status_id,$last_channel,$last_nick_id)=mysql_select1row("select level,last_status_id,last_channel,last_nick_id from tbl_users where id='$uid'");
