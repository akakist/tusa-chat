...
//            st.user_map_key1=rand(st.user_map_key);
            old_cookie=u->www_cookie;
            u->www_cookie=itostring(st.user_map_key);//get_des_hex_sid(st);
    ...
    string cookie=itostring(uid.container);//get_des_hex_sid(st);
