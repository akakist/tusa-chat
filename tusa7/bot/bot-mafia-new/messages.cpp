...
//	string repl;
//	repl=
//	"</b></b>Доступные команды: (набирать в общий канал, а не в приват)<br>"
//	"<b>!rules</b> - Правила игры<br>"
//	"<b>!вон [nick]</b> - Статистика nick'a, если ник опущен - то Ваша статистика<br>"
//	"<b>!place [nick]</b> - Место nick в рейтинге, или Ваше место, если ник пропущен<br>"
//	"<b>Желаем Вам удачной игры!</b><br>";
...
{
//	string repl;
//	repl="</b></b>Правила игры в <b>Мафию</b>:<br>"
//	"- Сообщение ролей в ночных фразах недопустимо<br>"
//	"- Мертвый не имеет право подсказывать другим, живым игрокам<br>"
//	"- Запрещены маты и оскорбление игроков<br>"
//	" Подробнее - читайте http://tusovka.tomsk.ru/html/help/mafia.html"
//	"<b>Нарушение правил карается походом в баню :)</b>"
//	;
