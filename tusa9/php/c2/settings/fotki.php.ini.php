...
<?
include '$BASE_DIR/inc/build_thumbnail.php';
include '$BASE_DIR/inc/cache_dir.php';
...
function make_image($im,$uid,$ismain,$descr)
{
	...
	else
	{
		...
		mysql_query("update photos set url_thumb_small='$TSU', url_scaled='$IRU', descr='".mysql_escape_string($descr)."' where id='$pid' and uid=$uid") or die(mysql_error());
