...
<?
	...
	if(isset($arg_edit))
	{
		...
		?>
		<center>
		<form name="fedit" method="POST" action='/admin/levels.php'>
...
$head="<tr>
	...
	while($row=mysql_fetch_row($req))
	{
		...
		echo "<tr>
		<td>$n</td>
		<td><a href='/admin/levels.php?edit=$id'>$id</a></td>
		<td>$names</td>
		<td>$msg_len</td>
		<td>$nicks_count</td>
		<td>$invisibility</td>
		...
		<td>$replacements</td>
		<td>
			<a href='/admin/levels.php?delete=$id'><img src='/pics/del.gif' border=0></a>
		</td>
		</tr>";
	}
?>
...
<form method='post' name=fadd>
		...
		<form name="fadd" method="POST" action='/admin/levels.php'>
		<table cellspacing=1 cellpadding=1 class=border>
