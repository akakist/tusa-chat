...
?>
<?
	$imgn=intval($_REQUEST["n"]);
?>
<script>
function sp(n)
{
//	alert(n);
	window.opener.document.getElementById('sp<?=$imgn?>').src='/pics/s/sp'+n+'.gif';
...
function ch(obj,num)
{
    ...
    if(lobj!=null){
		...
		document.getElementById('lx<?=$imgn?>x'+lnum).style.display='none';
    }
	document.getElementById('lx<?=$imgn?>x'+num).style.display='block';
...
#lx<?=$imgn?>x1 {display: none; width:300px}
#lx<?=$imgn?>x2 {display: none;  width:300px}
#lx<?=$imgn?>x3 {display: none;  width:300px}
#lx<?=$imgn?>x4 {display: none;  width:300px}
#lx<?=$imgn?>x5 {display: none;  width:300px}
#lx<?=$imgn?>x6 {display: none;  width:300px}
</style>
