<?
	...
	mysql_select1row("select 
	      info, foto_count, stat_last_date, screen_resolution, user_agent, stat_last_ip, credit_summa, setting_show_credits, level, setting_show_level, city, gender, hide_name, last_nick, foto_thumb_big, name, hide_bdate, year(birth_date),dayofyear(birth_date) from tbl_users where id='$aid'");
?>
<html>
<head>
