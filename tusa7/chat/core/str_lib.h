...
inline int operator< (const STRKEY &s1, const STRKEY &s2)
{
...
std::string replace_vals(std::map<STRKEY,std::string> &p, const std::string &src);
std::string replace_vals(const std::string &src);
std::string replace_re_vals(const std::map<std::string,std::string> &p, const std::string &src);
