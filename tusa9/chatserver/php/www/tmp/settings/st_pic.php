...
<TITLE>Чат "Тусовка" - Картинки к статусам</TITLE>
</head>
...
{
//	alert(n);
	var el=window.opener.document.getElementById('sp<?=$imgn?>');
	if(el)
	{
		el.src='/pics/s/sp'+n+'.gif';
	}
	window.opener.document.form1.spi<?=$imgn?>.value=n;
	window.close();
	return false;
}
lobj=null;
...
#l1 {visibility: hidden; position: absolute; left: 130; top: 40; width: 450}
#l2 {visibility: hidden; position: absolute; left: 130; top: 40; width: 450}
#l3 {visibility: hidden; position: absolute; left: 130; top: 40; width: 450}
#l4 {visibility: hidden; position: absolute; left: 130; top: 40; width: 450}
#l5 {visibility: hidden; position: absolute; left: 130; top: 40; width: 450}
#l6 {visibility: hidden; position: absolute; left: 130; top: 40; width: 450}
</style>
